...
The system automatically scales icons to smaller variants (Settings, notifications, etc.).

## Layer Design

- iOS/iPadOS/macOS/watchOS: background layer + foreground layers → Liquid Glass attributes (specular highlights, frostiness, translucency). Built with **Icon Composer** (included in Xcode).
...
- **Background**: subtle top-to-bottom light-to-dark gradient works well with system lighting. Keep full-bleed and opaque.
...
- **No replicas of Apple hardware** — copyrighted.
...
- **Alternate icons**: iOS/iPadOS/tvOS/compatible visionOS apps can offer alternate icons via in-app settings. Each alternate needs dark, clear, and tinted variants. Must be related to your app's content — never look like a different app.
