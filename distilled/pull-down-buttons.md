...
- **3+ items minimum** — fewer than 3 makes the open-and-pick interaction feel wasteful. For 1–2 items, prefer regular buttons (for actions) or toggles/switches (for selections).
